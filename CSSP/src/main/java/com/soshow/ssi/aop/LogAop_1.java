...
public class LogAop_1 {
	 ...
	 * @param joinPoint
	 */
	@Before("@annotation(com.soshow.ssi.annotation.Log)")
	...
	@After("@annotation(com.soshow.ssi.annotation.Log)")
	...
	@Around("@annotation(com.soshow.ssi.annotation.Log)")
